...
echo "=== Updating AssistantCore.java with Correct Hugging Face Path ==="
...
public class AssistantCore {
    ...
    public void downloadModel(DownloadCallback callback) {
        new Thread(() -> {
            try {
                // Correct LiteRT Community endpoint for TinyLlama
...
echo "=== Done! Re-compiled with fixed URL. Connect your device and run 'adb install -r app/build/outputs/apk/debug/app-debug.apk' to test. ==="
